...
<footer className="bg-[#2d3436] text-white mt-16">
  <div className="container mx-auto px-4 py-8 max-w-6xl">
    <div className="grid md:grid-cols-4 gap-8">
      ...
      {/* Legal & Charity Links */}
      <div>
        <h3 className="text-lg font-serif mb-3">Legal & Info</h3>
        <ul className="space-y-2 text-sm">
        ...
        <div className="mt-4">
          <p className="text-sm text-gray-400 mb-1">Saint Paul, Minnesota</p>
          <a href="mailto:info@neighborsos.org" className="text-sm text-gray-300 hover:text-white transition-colors">
      ...
      <div>
        ...
        <div className="flex gap-4 mb-4">
          ...
          <a 
            href="https://threads.net/@YOUR_HANDLE" 
            target="_blank" 
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
            aria-label="Threads"
